...
//for getting product id
	$query=mysqli_query($con,"SELECT auto_increment AS NEXT_ID FROM `information_schema`.`tables` WHERE  table_name = 'products' AND table_schema = '" . DB_NAME . "'");
	$result=mysqli_fetch_array($query);
	$productid=$result['NEXT_ID'];
	...
	$stmt->bind_param('iissssssssss', $category, $subcat, $productname, $productcompany, $productprice, $productdescription, $productscharge, $productavailability, $productimage1, $productimage2, $productimage3, $productpricebd);
	$stmt->execute();
	$stmt->close();
