                    ...
                    <div class="row  wow fadeInUp">
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                <h1 style="color: black; font-weight: lighter;" class="name">
...
?>
                                ...
                                <div class="stock-container info-container m-t-10">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="stock-box" style="font-weight: lighter;">
                                                <span style="color: black;" class="label">Availability :</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <div class="stock-box">
                                ...
                                <div class="stock-container info-container m-t-10">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="stock-box">
                                                <span style="color: black;" class="label">Product Brand :</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <div class="stock-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="price-box">
                                                ...
                                                <span
                                                    class="price-strike">Php<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
                                            </div>
                                        </div>
                                ...
                                <div class="quantity-container info-container">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-1">
                                            <span style="color: black;" class="label">Qty :</span>
                                        </div>
                                        ...
                                        <div class="col-sm-7">
                                            <a style="color: black; font-weight: bold; background:#ffde59;"
                                                href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>"
