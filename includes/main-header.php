...
<div class="main-header">
    <div class="container">
        <div class="row">
                ...
                <div class="search-area" style="background-color: white; border-color: gray;">
                    <form name="search" method="post" action="search-result.php">
                        <div class="control-group">
                            ...
                            <button class="search-button" style="border: none;" type="submit" name="search"></button>
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row" style="float: right">
                <?php
				if (!empty($_SESSION['cart'])) {
				?>
                            ...
                            <div class="cart-item product-summary">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        ...
                                        <div class="price">
                                            Php<?php echo ($row['productPrice'] + $row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="clearfix cart-total">
                                <div class="pull-right">
                                    ...
                                    <span class="text">Total :</span><span
                                        class='price'>Php<?php echo $_SESSION['tp'] = "$totalprice" . ".00"; ?></span>
                ...
                <?php } else { ?>
                <div class="dropdown dropdown-cart">
                    <a style="border-color: gray;" href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                        <div class="items-cart-inner">
                            <div class="total-price-basket">
                                <span class="lbl">cart -</span>
                                <span class="total-price">
                            ...
                            <div class="basket" style="border-color: black;">
                                <i class="glyphicon glyphicon-shopping-cart"></i>
                            </div>
