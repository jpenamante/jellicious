        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    <li><a href="verify.php" >Verify Account</a></li>
                </ul>
            </div>
        </div>
    </div> -->
        ...
        <div class="container">
            <div class="sign-in-page inner-bottom-sm">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account" style="margin-left: 300px;">
                        <h4 class="checkout-subtitle" >create a new account</h4>
                        <p class="text title-tag-line" >Create your own Shopping account. - <a href=verify.php>Verify Here</a></p>
                        <form class="register-form outer-top-xs" role="form" method="post"
                            action="emailverification.php" onSubmit="return valid();">
                            ...
                            <div class="form-group">
                                <label class="info-title" for="contactno" >Contact Number</label>
                            ...
                            <div class="form-group">
                                <label class="info-title" for="confirmpassword" >Confirm
                                    Password</label>
                                <input type="password" class="form-control unicase-form-control text-input"
